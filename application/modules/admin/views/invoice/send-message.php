                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p id="job-Id" class="form-control-static"><?php echo !empty($customer['last_name']) ? $customer['first_name'].' '.$customer['last_name'] : $customer['first_name'];?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p id="job-Id" class="form-control-static"><?php echo !empty($invoice['invoice']) ? $invoice['invoice'] : '' ?></p>
                                        <input type="hidden" class="sms_job_id" name="sms_job_id" value="<?php echo !empty($invoice['pk_id']) ? $invoice['pk_id'] : '' ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="autosize-transition form-control required" name="sms_message" rows="7" placeholder="Enter Description...">Hi <?php echo !empty($customer['customer_name']) ? $customer['customer_name'] : '' ?>( <?php echo !empty($customer['customer_id']) ? $customer['customer_id'] : '' ?> ),We are waiting for  your ************************* regarding Invoice:<?php echo !empty($invoice['invoice']) ? $invoice['invoice'] : '' ?>.Thank You, from <?php echo !empty($branch_admin['name']) ? $branch_admin['name']:''; ?>, <?php echo !empty($branch['name']) ? $branch['name']:'';?>,<?php echo !empty($branch['city']) ? $branch['city']:'';?>Phone: <?php echo !empty($branch['mobile_1']) ? $branch['mobile_1']:'';?>.</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
