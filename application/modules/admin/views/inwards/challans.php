<h3 class="header smaller lighter">
    ...
    <span class="pull-right">
         <a  href="#" onclick="goBack();" class="btn btn-xs btn-warning"><i class="fa fa-arrow-left"></i> Bavk</a>
    </span>
</h3>
...
<form class="form-inline text-center" method="get">
    ...
    <a href="<?php echo base_url() ?>admin/inwards/challans/" class="btn btn-xs btn-danger"><i class="fa fa-refresh"></i> Refresh </a>
</form>
            ...
            if (!empty($inwards)) {
                ...
                foreach ($inwards as $inward) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $inward['inward_challan'] ?>
                            <span class="info">
                        <a href="<?php echo base_url() ?>admin/inwards/challan-view/?challan=<?php echo $inward['inward_challan_id'] ?>" class="badge badge-success" data-toggle="tooltip" title="View Job on this Challan"><i class="fa fa-search"></i></a>
                    </span>
                        </td>
