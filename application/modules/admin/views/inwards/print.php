<?php
if (empty($inwards)) {
    redirect(base_url() . 'admin/inwards/add');
}
?>
<style>
...
<h3 class="header smaller lighter hidden-print">
    ...
    <span class="pull-right">
        <a href="<?php echo get_role_based_link() ?>/inwards/add" class="btn btn-warning btn-xs"> <i class='fa fa-arrow-left'></i> Back</a>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 no-padding border">
                        <div class="col-md-9 col-sm-9  col-xs-8 text-center no-padding border-right">
                            ...
                            if (!empty($branch_data['branch_logo']) && file_exists(FCPATH . $path . $branch_data['branch_logo'])) { ?>
                                <img style="max-height:140px;max-width: 127px" class="max-100 mw-127 m-15 f-l preview-pic" alt="Branch Logo" src="<?php echo base_url() . $path . $branch_data['branch_logo']; ?>"/>
                            <?php } ?>
                            <h4><?php
                            ...
                            <p> <?php echo !empty($branch_data['branch_info']) ? $branch_data['branch_info'] : '' ?></p>
                        </div>
                        <div class="col-md-3">
                            <h4>INWARD CHALLAN</h4>
                            <h5 style="font-size:13px;margin-left:15px;"><b> <?php echo !empty($inwards[0]['inward_challan']) ? $inwards[0]['inward_challan'] : 'NA'; ?> </b></h5>
