            ...
            $('#id-add-attachment')
                .on('click', function () {
                    ...
                    file.closest('.ace-file-input')
                        .addClass('width-90 inline')
                        .wrap('<div class="form-group file-input-container"><div class="col-sm-7"></div></div>')
                        .parent().append('<div class="action-buttons pull-right col-xs-1"><a href = "#" data-action = "delete" class = "middle" ><i class= "ace-icon fa fa-trash-o red bigger-130 middle" ></i></a></div>')
