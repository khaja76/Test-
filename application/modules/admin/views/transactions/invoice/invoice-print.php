...
<?php
if ((isset($_GET['customer_id']) && !empty($invoice) && !empty($_GET['customer_id']))) {
    ?>
    <div class="quote">
        <div class="widget-box transparent">
            ...
            <div class="widget-body">
                <div>
                    <div class="row">
                        ...
                        <div class="col-sm-4 print-half col-md-offset-2">
                            ...
                            <ul class="list-unstyled spaced">
                                <li>
                                    <b><span class="w-150 f-l"><?php echo (!empty($_GET['transaction'])) ? "Invoice" : '' ?> No</span> </b> : <span class="m-l-10"><?php echo !empty($invoice) ? $invoice['invoice'] : '' ?></span>
                                </li>
                                <li>
                                    <b><span class="w-150 f-l">Invoice Date</span> </b>: <span class="m-l-10"><?php echo !empty($invoice) ? dateDB2SHOW($invoice['invoice_date']) : '' ?></span>
                                </li>
                                <li class="bg-gray p-10">
                                    <div>
                                        <b><span class="w-150 f-l">Invoice Amount </span> </b>: <span class="m-l-10"><b><i class='fa fa-inr'></i> <?php echo !empty($invoice) ? number_format($invoice['final_amount'], 2) : '' ?></b></span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            if (!empty($invoice_jobs)) {
                                ...
                                foreach ($invoice_jobs as $invoice_job) {
                                    ...
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td>
                                            <b><?php echo $invoice_job['job_id'] ?></b><br>
                                            <?php echo $invoice_job['description'] ?>
                                        </td>
                                        <td><?php echo $invoice_job['status'] ?></td>
                                        <td><?php echo $invoice_job['remarks'] ?></td>
                                        <td><?php echo $invoice_job['amount'] ?></td>
                                    </tr>
                                    <?php
                                    $i++;
                                }
                ...
                <div class="row">
                    <div class="col-sm-4 pull-right">
                        <h6><b><span class="w-150 f-l">Net Amount</span> </b>
                            :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($invoice) ? number_format($invoice['total_amount'], 2) : '' ?></span>
                        </h6>
                        <h6><b><span class="w-150 f-l">CGST Amount </span> </b>
                            :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($invoice) ? number_format($invoice['cgst_amount'], 2) : '' ?></span>
                        </h6>
                        <h6><b><span class="w-150 f-l">SGST Amount  </span> </b>
                            :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($invoice) ? number_format($invoice['sgst_amount'], 2) : '' ?></span>
                        </h6>
                        <h6><b><span class="w-150 f-l">IGST Amount </span> </b>
                            :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($invoice) ? number_format($invoice['igst_amount'], 2) : '' ?></span>
                        </h6>
                        <h6><b><span class="w-150 f-l">Shipping & Handling </span> </b>
                            :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($invoice) ? number_format($invoice['ship_handling_amount'], 2) : '' ?></span>
                        </h6>
                        <h5 class="bg-gray p-10">
                            <b><span class="w-150 f-l">Final Amount</span> </b> :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($invoice) ? number_format($invoice['final_amount'], 2) : '' ?></span>
                        </h5>
                    </div>
                    <div class="col-sm-7 pull-left">
                        <?php
                        if (!empty($invoice) && !empty($invoice['notes'])) { ?>
                            <h5 class='red '>Notes : </h5>
                            <textarea readonly class="textarea-custom notes">
                                    <?php
                                    echo trim($invoice['notes']);
                                    ?>
                                </textarea>
                        <?php } ?>
                    </div>
                ...
                <!-- <textarea readonly class="textarea-custom terms smaller-80">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Eiusmod tempor incididunt ut labore et dolore magna aliqua.</textarea>-->
