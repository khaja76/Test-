<h3 class="header smaller lighter">
    Transactions - <span class="text-success bolder ">Invoice</span>
                ...
                <span class="pull-right">
                 ...
                 <label> Invoice Date</label>
                       <div class="form-group">
                           <input type="text" name="invoice_date" data-date-format="dd/mm/yyyy" class="form-control date-picker input-sm required"/>
                       </div>
                 </div>
            </span>
            </h4>
            <input type="hidden" name="trans" value="<?php echo $_GET['transaction'] ?>"/>
            <?php if ($_GET['transaction'] == 'invoice' && isset($_GET['inward_no'])) {
                ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="amount" placeholder="  Amount " class="form-control q_amount input-sm required" onkeypress="return isNumber(event)"/></td>
                    </tr>
                    </tbody>
                </table>
            <?php } else if (($_GET['transaction'] == 'invoice') && isset($_GET['customer_id'])) { ?>
                    ...
                    <?php if (!empty($inwards)) {
                        ...
                        foreach ($inwards as $inward) {
                            ...
                            <tr>
                                ...
                                <td><textarea class="form-control" name="remarks[]"></textarea></td>
                                <td><input type="text" name="amount[]" id="amount" onkeypress="return isNumber(event)" placeholder="  Amount " class="form-control q_amount input-sm m-t-10 required"/></td>
                            </tr>
                        <?php }
                    } else {
                    }
