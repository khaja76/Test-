<h3 class="header smaller lighter">
    Transactions - <span class="text-success bolder ">Quotation</span>
...
<div class="row">
    <div class="col-lg-12 transactions_details">
        <form method="post" action="" id="frm" class="form-horizontal ">
                 ...
                 <div class="col-md-12 ">
                        <label for="q_date">Quotation Date</label>
                            ...
                            <div class="form-group">
                                <input type="text" id="q_date" name="quotation_date" data-date-format="dd/mm/yyyy" class="form-control input-sm required date-picker"/>
                            </div>
            ...
            <?php if ($_GET['transaction'] == 'quotation' && isset($_GET['inward_no'])) {
                ?>
                <input type="hidden" name="inward_no" value="<?php echo $_GET['inward_no'] ?>"/>
                <input type="hidden" name="customer_id" value="<?php echo $customer['pk_id'] ?>"/>
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><input type="hidden" value="<?php echo $inward['pk_id'] ?>" name="job_id"/>
            ...
            <?php } else if (($_GET['transaction'] == 'quotation') && isset($_GET['customer_id'])) { ?>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <?php if (!empty($inwards) && isset($_GET['customer_id'])) {
                        $i = 0;
