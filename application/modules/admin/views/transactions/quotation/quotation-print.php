...
<div class="col-md-12">
    <?php
    if ((isset($_GET['customer_id']) && !empty($_GET['customer_id'])) && (isset($_GET['transaction']) && ($_GET['transaction'] == 'invoice' || $_GET['transaction'] == 'quotation'))) {
    ?>
    <div class="quote">
        <div class="widget-box transparent">
            <div class="row">
                <div class="col-sm-6 print-half">
                    <img src="/data/ltheader.png" alt="HiFi"/>
                </div>
                ...
                <div>
                    <div class="row">
                        <div class="col-sm-6 print-half">
                            <div class="row">
                                <div class="col-xs-11">
                                    <h4 class="gray"><?php echo ucwords($_GET['transaction']) ?> To</h4>
                                </div>
                            </div>
                            <div>
                                <?php
                        ...
                        <div class="col-sm-4 print-half col-md-offset-2">
                            <div class="row">
                                <div class="col-xs-12">
                                    <h4 class="grey"><?php echo ucwords($_GET['transaction']) ?> Information</h4>
                                </div>
                            </div>
                            <div
                            <ul class="list-unstyled spaced">
                                ...
                                <li>
                                    <b><span class="w-150 f-l"><?php echo (!empty($_GET['transaction']) && ($_GET['transaction'] == 'quotation')) ? ucwords($_GET['transaction']) : '' ?> No</span> </b> : <span class="m-l-10"><?php echo !empty($quotation) ? $quotation['quotation'] : '' ?></span>
                                </li>
                                <li>
                                    <b><span class="w-150 f-l"><?php echo ucwords($_GET['transaction']) ?> Date</span> </b>: <span class="m-l-10"><?php echo !empty($quotation) ? dateDB2SHOW($quotation['quotation_date']) : '' ?></span>
                                </li>

                                <li class="bg-gray p-10">
                                    <div>
                                        <b><span class="w-150 f-l"><?php echo ucwords($_GET['transaction']) ?> Amount </span> </b>: <span class="m-l-10"><b><i class='fa fa-inr'></i> <?php echo !empty($quotation) ? number_format($quotation['final_amount'], 2) : '' ?></b></span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row inv">
                    <div class="col-md-12">
                        <table class="table table-striped">
                            ...
                            <tbody>
                            <?php
                            if (!empty($quotation_jobs)) {
                                $i = 1;
                                foreach ($quotation_jobs as $quotation_job) {
                                    ?>
                                    <tr>
                                        <td><?php echo $i ?></td>
                                        <td>
                                            <?php echo $quotation_job['job_id'] ?><br>
                                            <?php echo $quotation_job['description'] ?>
                                        </td>
                                        <td><?php echo $quotation_job['status'] ?></td>
                                        <td><?php echo $quotation_job['remarks'] ?></td>
                                        <td><?php echo $quotation_job['amount'] ?></td>
                                    </tr>
                                    <?php
                                    $i++;
                                }
                ...
                <div class="row">
                    <div class="col-sm-4 pull-right">
                        <h6><b><span class="w-150 f-l">Net Amount</span> </b>
                            :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($quotation) ? number_format($quotation['total_amount'], 2) : '' ?></span>
                        </h6>

                        <h6><b><span class="w-150 f-l">CGST Amount </span> </b>
                            :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($quotation) ? number_format($quotation['cgst_amount'], 2) : '' ?></span>
                        </h6>
                        <h6><b><span class="w-150 f-l">SGST Amount  </span> </b>
                            :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($quotation) ? number_format($quotation['sgst_amount'], 2) : '' ?></span>
                        </h6>
                        <h6><b><span class="w-150 f-l">IGST Amount </span> </b>
                            :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($quotation) ? number_format($quotation['igst_amount'], 2) : '' ?></span>
                        </h6>
                        <h5 class="bg-gray p-10">
                            <b><span class="w-150 f-l">Final Amount</span> </b> :
                            <span class="m-l-10"><i class="fa fa-inr"></i> <?php echo !empty($quotation) ? number_format($quotation['final_amount'], 2) : '' ?></span>
                        </h5>
                    </div>
                    <div class="col-sm-7 pull-left">
                        <?php if (!empty($quotation) && !empty($quotation['notes'])) { ?>
                            <h5 class='red '>Notes : </h5>
                            <textarea readonly class="textarea-custom notes">
                                    <?php

                                    echo trim($quotation['notes']);
