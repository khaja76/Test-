    ...
    <div style="width:90%;margin: 0 auto;">
        ...
        <div style=" border: 1px solid #fff; border-radius: 6px; background: #FFF; float: left; width: 91%;padding: 15px 30px;">
           ...
           <p>Greetings from <?php echo $product_name; ?>,</p><br/>
            <p>Your Login Email is <b><?php echo !empty($email) ? $email : ""; ?></b>. </p>
            <p>Your current Password is <b><?php echo !empty($password) ? $password : ""; ?></b>. </p>
            <p>Your Registered Phone Number is <b><?php echo !empty($phone) ? $phone : ""; ?></b> and your Role is <b><?php echo !empty($role) ? $role : ""; ?></b>. </p>
            <br/>
