<?php $product_name = !empty($branch_data['name']) ? $branch_data['name'] : ''; ?>
<div style="width: 85%;float: left;display: block;font-size: 14px; color: #333;background: #f2f2f2; margin: 10px auto; max-width: 640px; padding: 20px 50px;">
    <div style="width:90%;margin: 0 auto;">
        <div style="width:100%;margin-bottom: 15px;">
            <div style="width:50%;float: left;"><h4>
            ...
            <div style="width:50%;float: left;text-align:right">
                <img src="<?php echo base_url() ?>data/branches/<?php echo !empty($branch_data['branch_logo']) ? $branch_data['branch_logo'] : ''; ?>" alt="<?php echo $product_name; ?>" width="100" height="100"/></div>
        </div>
        <div style=" border: 1px solid #fff; border-radius: 6px; background: #FFF; float: left; width: 91%;padding: 15px 30px;">
            ...
            <p>Greetings from <?php echo !empty($branch_data['name']) ? $branch_data['name'] : ''; ?>,</p><br/>
            <p>Your Inward Challan is <b><?php echo !empty($inward_challan) ? $inward_challan : ""; ?></b>. </p>
            <p> We will update product repair status soon.</p>
            <br/>
